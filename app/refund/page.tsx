    ...
    <div className="min-h-screen bg-background pb-24 lg:pb-0">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        <nav className="mb-8 flex items-center gap-1.5 text-xs text-muted-foreground">
          ...
          <span className="text-foreground">{t.footer.support.refundPolicy}</span>
        </nav>
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-4 text-muted-foreground">
          <p>{t.terms.sections.returnsText}</p>
          <p>
            يرجى التأكد من أن المنتج في عبواته الأصلية وغير مفتوح. تواصل مع خدمة العملاء عبر صفحة اتصل بنا لبدء عملية الإرجاع.
          </p>
        </div>
      </main>
