    ...
    <div className="min-h-screen bg-background pb-24 lg:pb-0">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        <nav className="mb-6 flex items-center gap-1.5 text-xs text-muted-foreground">
          ...
          <ChevronRight className="h-3.5 w-3.5" />
          <span className="text-foreground">{t.account.profile}</span>
        </nav>
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-muted/20 py-16">
          ...
          <h2 className="mb-2 text-xl font-semibold text-foreground">{t.account.loginRequired}</h2>
          <p className="mb-6 text-center text-sm text-muted-foreground">
            {t.account.profileEmpty}
          </p>
          <Button asChild>
